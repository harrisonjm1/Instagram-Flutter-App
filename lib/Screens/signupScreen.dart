...
import 'package:flutter_instagram_app/Methods/auth_method.dart';
...
import 'package:flutter_instagram_app/CustomWidgets/input_text.dart';

import '../Utilities/imagePickerUtil.dart';
  ...
  void signUpUser() async {
    ...
    if (res == "success") {
      ...
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) => const AdjustLayout(
